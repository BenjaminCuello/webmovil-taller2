...
Usa esta guía rápida para validar la app en los distintos modos (`mock`, `public`, `local`).
...
------------------------------------
- [ ] Landing responsive en mobile/tablet/desktop.
- [ ] Navegación a detalle y retorno funcionan (`Volver` y popstate).
- [ ] Estados de carga y toasts visibles en cada módulo.
- [ ] Selección de modo persiste tras recargar la página.
- [ ] `frontend/www/js/config.js` documentado con URLs correctas.
- [ ] README principal actualizado con instrucciones recientes.
