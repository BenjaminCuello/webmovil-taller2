...
if (btnVolver) {
  btnVolver.addEventListener('click', function () {
    ...
    // Si estamos en detalle de un ítem dentro de un recurso (no hay grid),
    // volvemos a la lista de ese recurso manteniendo ?recurso=...
    ...
    // Si estamos en la lista del recurso (o sin recurso), volvemos al inicio (/)
